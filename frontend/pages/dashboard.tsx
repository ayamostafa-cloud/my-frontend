...
export default function Dashboard() {
  ...
  function handleLogout() {
    localStorage.clear();
    router.push("/"); // ✅ ONLY CHANGE: go to home page
  }
      ...
      {role === "HR Employee" && (
        <div>
          ...
          <p>
            ...
            <button
              type="button"
              className="mb-6 bg-purple-600 px-4 py-2 rounded hover:bg-purple-700"
              onClick={() => router.push("/hr/employees/create-manager")}
            >
              + Create Manager
            </button>
          </p>
